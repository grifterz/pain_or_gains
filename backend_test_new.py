...
class MemeAnalyzerTester:
    def __init__(self, base_url="https://418b7862-b0d9-4a59-8a0a-b0cdf2b40a11.preview.emergentagent.com"):
...
def main():
    ...
    tester.test_analyze_solana_wallet("GPT8wwUbnYgxckmFmV2Pj1MYucodd9R4P8xNqv9WEwrr")
    tester.test_analyze_base_wallet("0x671b746d2c5a34609cce723cbf8f475639bc0fa2")
    tester.test_analyze_random_wallet("0x8c87af79c0b9bb8856a5ca09cb5a2a0a38b8f43e")
    
    # Test leaderboards
    for stat_type in ["best_trade", "best_multiplier", "all_time_pnl", "worst_trade"]:
        tester.test_solana_leaderboard(stat_type)
        tester.test_base_leaderboard(stat_type)
